...
export var ReferenceField = function (props) {
    ...
    return id == null ? (emptyText ? (React.createElement(Typography, { component: "span", variant: "body2" }, emptyText && translate(emptyText, { _: emptyText }))) : null) : (React.createElement(NonEmptyReferenceField, __assign({}, rest, { link: link, emptyText: emptyText, record: record, id: id })));
};
...
export var ReferenceFieldView = function (props) {
    ...
    return (React.createElement(Root, { className: className, sx: sx },
        React.createElement(RecordContextProvider, { value: referenceRecord }, child)));
};
