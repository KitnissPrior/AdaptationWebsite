...
export var LocalesMenuButton = function (props) {
    ...
    return (React.createElement(Root, { component: "span" },
        React.createElement(Button, { color: "inherit", variant: "text", "aria-controls": "simple-menu", "aria-label": "", "aria-haspopup": "true", onClick: handleLanguageClick, startIcon: React.createElement(LanguageIcon, null), endIcon: React.createElement(ExpandMoreIcon, { fontSize: "small" }) }, getNameForLocale(locale)),
