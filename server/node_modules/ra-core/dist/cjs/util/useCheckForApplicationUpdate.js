...
var useCheckForApplicationUpdate = function (options) {
    var _a = options.url, url = _a === void 0 ? window.location.href : _a, _b = options.interval, delay = _b === void 0 ? ONE_HOUR : _b, onNewVersionAvailableProp = options.onNewVersionAvailable, _c = options.disabled, disabled = _c === void 0 ? process.env.NODE_ENV !== 'production' : _c;
    var currentHash = (0, react_1.useRef)();
    var onNewVersionAvailable = (0, useEvent_1.useEvent)(onNewVersionAvailableProp);
    (0, react_1.useEffect)(function () {
        if (disabled)
            return;
        getHashForUrl(url).then(function (hash) {
            if (hash != null) {
...
var getHashForUrl = function (url) { return __awaiter(void 0, void 0, void 0, function () {
