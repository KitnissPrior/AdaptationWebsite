...
var LocalesMenuButton = function (props) {
    ...
    return (React.createElement(Root, { component: "span" },
        React.createElement(material_1.Button, { color: "inherit", variant: "text", "aria-controls": "simple-menu", "aria-label": "", "aria-haspopup": "true", onClick: handleLanguageClick, startIcon: React.createElement(Translate_1.default, null), endIcon: React.createElement(ExpandMore_1.default, { fontSize: "small" }) }, getNameForLocale(locale)),
