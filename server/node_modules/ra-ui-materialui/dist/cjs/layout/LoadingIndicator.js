...
var LoadingIndicator = function (props) {
    ...
    return (React.createElement(Root, { className: className, sx: sx },
        React.createElement(button_1.RefreshIconButton, { className: "".concat(exports.LoadingIndicatorClasses.loadedIcon, " ").concat(loading && exports.LoadingIndicatorClasses.loadedLoading) }),
...
var Root = (0, styles_1.styled)('div', {
    ...
    return (_b = {
        ...
        _b["& .".concat(exports.LoadingIndicatorClasses.loadedIcon)] = (_c = {},
            _c["&.".concat(exports.LoadingIndicatorClasses.loadedLoading)] = {
                opacity: 0,
            },
            _c),
