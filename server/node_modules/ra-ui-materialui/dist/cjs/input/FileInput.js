...
var FileInput = function (props) {
    var accept = props.accept, children = props.children, className = props.className, format = props.format, helperText = props.helperText, inputPropsOptions = props.inputProps, maxSize = props.maxSize, minSize = props.minSize, _a = props.multiple, multiple = _a === void 0 ? false : _a, label = props.label, _b = props.labelMultiple, labelMultiple = _b === void 0 ? 'ra.input.file.upload_several' : _b, _c = props.labelSingle, labelSingle = _c === void 0 ? 'ra.input.file.upload_single' : _c, _d = props.options, options = _d === void 0 ? {} : _d, onRemoveProp = props.onRemove, parse = props.parse, placeholder = props.placeholder, removeIcon = props.removeIcon, resource = props.resource, source = props.source, validate = props.validate, validateFileRemoval = props.validateFileRemoval, rest = __rest(props, ["accept", "children", "className", "format", "helperText", "inputProps", "maxSize", "minSize", "multiple", "label", "labelMultiple", "labelSingle", "options", "onRemove", "parse", "placeholder", "removeIcon", "resource", "source", "validate", "validateFileRemoval"]);
    ...
    return (react_1.default.createElement(StyledLabeled, __assign({ htmlFor: id, label: label, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), source: source, resource: resource, isRequired: isRequired, color: (isTouched || isSubmitted) && invalid ? 'error' : undefined }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest)),
        react_1.default.createElement(react_1.default.Fragment, null,
            ...
            renderHelperText ? (react_1.default.createElement(FormHelperText_1.default, { error: (isTouched || isSubmitted) && invalid },
                react_1.default.createElement(InputHelperText_1.InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText }))) : null,
...
exports.FileInput.propTypes = {
    ...
    removeIcon: prop_types_1.default.elementType,
