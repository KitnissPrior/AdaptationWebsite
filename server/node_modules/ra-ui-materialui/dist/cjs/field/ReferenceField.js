...
var ReferenceField = function (props) {
    var source = props.source, emptyText = props.emptyText, _a = props.link, link = _a === void 0 ? 'edit' : _a, rest = __rest(props, ["source", "emptyText", "link"]);
    var record = (0, ra_core_1.useRecordContext)(props);
    var id = (0, get_1.default)(record, source);
    var translate = (0, ra_core_1.useTranslate)();
    return id == null ? (emptyText ? (React.createElement(material_1.Typography, { component: "span", variant: "body2" }, emptyText && translate(emptyText, { _: emptyText }))) : null) : (React.createElement(exports.NonEmptyReferenceField, __assign({}, rest, { link: link, emptyText: emptyText, record: record, id: id })));
};
...
var ReferenceFieldView = function (props) {
    ...
    return (React.createElement(Root, { className: className, sx: sx },
        React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord }, child)));
};
