...
import { UseCheckForApplicationUpdateOptions } from 'ra-core';
/**
 ...
 * );
 */
export declare const CheckForApplicationUpdate: (props: CheckForApplicationUpdateProps) => any;
export interface CheckForApplicationUpdateProps extends Omit<UseCheckForApplicationUpdateOptions, 'onNewVersionAvailable'> {
    notification?: ReactElement;
}
//# sourceMappingURL=CheckForApplicationUpdate.d.ts.map